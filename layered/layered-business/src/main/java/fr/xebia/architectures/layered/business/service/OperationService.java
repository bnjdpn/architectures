...
public class OperationService {
    ...
    public List<Operation> findOperations(String accountId, Instant startOperationDate, Instant endOperationDate) {
        ...
        return operationRepository.findOperationsByAccountIdAndDateBetweenOrderByDateDesc(accountId, startOperationDate,
                endOperationDate);
    }
    ...
    private double getNewPotentialAccountAmount(Account account, Operation operation) {
        ...
        double operationAmountWithAccountCurrency =
